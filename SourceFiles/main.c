...
#include "C:\Users\Saladboy\Desktop\C projects\GameA\HeaderFiles\Main.h"
...
DWORD CreateMainGameWindow(void)
{
    ...
    WindowClass.lpszClassName = GAME_NAME "GAME_A_WINDOWCLASS";
...
{
    short EscKeyIsDown = GetAsyncKeyState(VK_ESCAPE);
